...
//       bool expected = greater_than ? xinp0[i] > xinp1[i] : xinp0[i] <
//       xinp1[i]; bool got_cmp = xout0[i] ^ xout1[i]; ASSERT_EQ(expected,
//       got_cmp);
//     }
//   });
// }
...
//     for (int64_t i = 0; i < shape.numel(); ++i) {
//       bool expected = greater_than ? xinp0[i] > xinp1[i] : xinp0[i] <
//       xinp1[i]; bool got_cmp = xout0[i] ^ xout1[i]; bool got_eq = xeq0[i] ^
//       xeq1[i]; EXPECT_EQ(expected, got_cmp); EXPECT_EQ((xinp0[i] ==
//       xinp1[i]), got_eq);
//     }
//   });
// }
