...
def f_greater_4(input):
    # Add necessary preprocessing code
    return _f_greater_4_prim.bind(input)
...
def _f_greater_4_jvp(args, tangents):
...
def _f_greater_4_batch(args, axes):
    raise NotImplementedError()
...
# *********************************************
_f_greater_4_prim = core.Primitive("f_greater_4")
# Change this to True if there are more than 1 output
_f_greater_4_prim.multiple_results = False
_f_greater_4_prim.def_impl(partial(xla.apply_primitive, _f_greater_4_prim))
_f_greater_4_prim.def_abstract_eval(_f_greater_4_abstract)

mlir.register_lowering(_f_greater_4_prim, _f_greater_4_lowering)

# Connect the JVP and batching rules
ad.primitive_jvps[_f_greater_4_prim] = _f_greater_4_jvp
batching.primitive_batchers[_f_greater_4_prim] = _f_greater_4_batch
